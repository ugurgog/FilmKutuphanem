package uren.com.filmktphanem.login;
...
import uren.com.filmktphanem.FirstOpen.SplashScreenActivity;
...
import uren.com.filmktphanem.Utils.dataModelUtil.UserDataUtil;
import uren.com.filmktphanem.dbManagement.UserDBHelper;
import uren.com.filmktphanem.login.utils.Validation;
import uren.com.filmktphanem.models.LoginUser;
import uren.com.filmktphanem.models.User;

import static uren.com.filmktphanem.Constants.StringConstants.LOGIN_METHOD_GOOGLE;
import static uren.com.filmktphanem.Constants.StringConstants.LOGIN_USER;
...
public class LoginActivity extends AppCompatActivity
    ...
    private void setUserInfo(String name, String userEmail) {

        if (!name.isEmpty()) {
            loginUser.setName(name);
        } else {
            loginUser.setName("undefined");
        }
                            ...
                            UserDBHelper.getUser(user.getUid(), new CompleteCallback() {
                                ...
                                public void onComplete(Object object) {
                                    if(object == null || ((User) object).getUserid() == null){
                                        String username = UserDataUtil.getNameFromNameWhenLoginWithGoogle(user.getDisplayName());

                                        User newUser = new User(user.getUid(), user.getDisplayName(),
                                                user.getEmail(), user.getPhotoUrl().toString(), false, LOGIN_METHOD_GOOGLE);

                                        UserDBHelper.addUser(newUser, new OnCompleteCallback() {
                                            @Override
                                            public void OnCompleted() {
                                                setUserInfo(user.getDisplayName(), user.getEmail());
                                                startAppIntroPage();
                                            }
