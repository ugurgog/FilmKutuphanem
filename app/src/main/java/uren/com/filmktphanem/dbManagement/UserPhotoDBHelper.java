...
import uren.com.filmktphanem.Utils.BitmapConversion;
import uren.com.filmktphanem.models.PhotoSelectUtil;


public class UserPhotoDBHelper {

    public static void uploadUserPhoto(Context context, String userid, PhotoSelectUtil photoSelectUtil,
        ...
        final StorageReference storageRef = storage.getReference().child("images").child("users").child(userid + "/profilephoto.jpg");
