...
import uren.com.filmktphanem.Utils.dialogBoxUtil.Interfaces.CustomDialogListener;
import uren.com.filmktphanem.Utils.dialogBoxUtil.Interfaces.CustomDialogReturnListener;
        ...
        public CustomDialogBox build() {
            ...
            if (user != null) {
                UserDataUtil.setProfilePicture(this.activity, user.getProfilePhotoUrl(),
                        user.getName(), shortUserNameTv, profilePicImgView);
                UserDataUtil.setName(user.getName(), usernameTextView);
            }else
