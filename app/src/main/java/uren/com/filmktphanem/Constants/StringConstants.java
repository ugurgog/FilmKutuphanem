...
public class StringConstants {
    ...
    public static final String APP_NAME = "My Movie Library";
    ...
    public static final String APP_PACKAGE_NAME = "uren.com.filmktphanem";
    public static final String APP_FB_URL = "https://my-movie-library-d6a16.firebaseio.com/";
